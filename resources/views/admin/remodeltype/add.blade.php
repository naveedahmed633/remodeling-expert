                    ...
                    <div class="col-12">
                        <div class="card card-box-shadow mt-5">
                            <div class="card-header">
                                ...
                                <a href="{{ route('admin.form.index') }}" class="btn btn-primary btn-sm float-right">
                                    Back
                                </a>
                            </div>
                            <div class="card-body">
                                <form
                                    action="{{ isset($service) ? route('admin.form.update', $service->id) : route('admin.form.store') }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="serviceName"
                                                    ...
                                                    value="{{ old('serviceName', $service->name ?? '') }}">
                                                @error('serviceName')
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div id="sub_services_wrapper">
                                                    @if (isset($service) && $service->subServices)
                                                        @foreach ($service->subServices as $index => $sub)
                                                            <div class="sub-service-item">
                                                                ...
                                                                <button type="button"
                                                                    class="remove-btn removeSubService">Remove</button>

                                                                <!-- Remodel Types -->
                                                                <div class="remodel-types-wrapper">
                                                                    @foreach ($sub->remodelTypes as $remodel)
                                                                        <div class="remodel-type-item">
                                                                            <input type="text" class="form-control"
                                                                                name="sub_services[{{ $index }}][remodel_types][][name]"
                                                                                value="{{ $remodel->name }}"
                                                                                placeholder="Enter Remodel Type Name"
                                                                                required>
                                                                            <button type="button"
                                                                                class="remove-btn removeRemodelType">Remove</button>
                                                                        </div>
                                                                    @endforeach
                                                                </div>
                                                                <button type="button"
                                                                    class="add-btn btn-sm addRemodelTypeBtn"
                                                                    data-index="{{ $index }}">+ Add Remodel
                                                                    Type</button>
                                                            </div>
                                                        @endforeach
                                                    @else
                                                        <div class="sub-service-item">
                                                            <input type="text" class="form-control"
                                                                name="sub_services[0][name]"
                                                                placeholder="Enter Sub-Service Name" required>
                                                            <button type="button"
                                                                class="remove-btn removeSubService">Remove</button>

                                                            <div class="remodel-types-wrapper"></div>
                                                            <button type="button" class="add-btn btn-sm addRemodelTypeBtn"
                                                                data-index="0">+ Add Remodel Type</button>
                                                        </div>
                                                    @endif
                                                </div>

                                                <button type="button" class="add-btn btn-sm" id="addSubServiceBtn">+ Add
                                                    Sub-Service</button>
                                            </div>
                                        </div>
