...
@section('content')
    ...
    <div class="content-wrapper">
        <form action="{{ route('admin.pages.update', $slug) }}" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="media_collections[]" value="event_banner_img">
            @csrf
                        ...
                        <div class="col-12">
                            <div class="card card-box-shadow mt-5">
                                <div class="card-header">
                                    <h3 class="card-title">Update Events Content</h3>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="title">Events Bg-Image</label>
                                                <input type="file" class="form-control form__field"
                                                    name="event_banner_img" id="cta_image">
                                                @if ($page->hasMedia('event_banner_img'))
                                                    <label for="existing_background_banner_image"></label>
                                                    @foreach ($page->getMedia('event_banner_img') as $media)
